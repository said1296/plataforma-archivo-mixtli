   ...
   <div class="row">       
      ...
      <div class="col-lg-4 col-md-6">
         ...
         <form class="relative" action=""  method="POST">
            ...
            <label for="input-label" class="text-left">Usuario</label>
            <input type="text" REQUIRED name="usuario" placeholder="Ingrese su nombre de usuario..." /><br /><br />
      ...
      <?php
         $SerieID = $row_serie['id'];
         if($_SERVER['REQUEST_METHOD'] === 'POST'){
            if(isset($_POST['submit'])){
               $Usuario = $_POST['usuario'];
               $Comentario = $_POST['comentario'];
            
               $query = "INSERT INTO comentarios_series (SerieID,Usuario,Comentario) VALUES('$SerieID','$Usuario','$Comentario')";
                            ...
                            <div class="media-body">
                                <span class="text-muted pull-right">
                                    ...
                                    <?php
                                       if($admin==1){
                                    ?>
                                    <a href="series_eliminar_comentario_serie.php?ComentarioID=<?php echo $row['ComentarioID']."&".$_SERVER['QUERY_STRING'] ?>" class="btn btn-lg btn-red">X</a>
                                    <?php
                                       }
                                    ?>
                                </span>
