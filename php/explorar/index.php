     ...
     <div class="hero-holder">
      <div class="hero-message text-rotator">
	   ...
	   ?>
        ...
        <a href="grupo.php?grupo=<?php echo $fiestas ?>" class="btn btn-lg btn-blue">Las fiestas del pueblo</a>
        <a href="grupo.php?grupo=<?php echo $vida ?>" class="btn btn-lg btn-red">Vida cotidiana</a>
        <a href="grupo.php?grupo=<?php echo $paisaje ?>" class="btn btn-lg btn-yellow">Arquitectura y paisaje</a>
       </div>
