                           ...
                           <div class="right">
                              <p>&nbsp;
                                 <ul class="text-center">
                                    <a href="../colecciones/viewimg.php?id=<?php echo $row['id']; ?>">
                                       <li class="btn btn-sm btn-light">Descargar</li>
                                    </a>
                                    <a href="ver_historia.php?id=<?php echo $_GET['id_historia']; ?>">
                                       <li class="btn btn-sm btn-red">Regresar</li>
                                    </a>
                                 </ul>
                              </p>
                           </div>
