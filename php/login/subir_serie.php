...
<head>
  ...
  <title>Publicación de serie| Preservación Digital</title>
   ...
   <div class="container">
    <div class="row">
     <div class="">
      ...
      <form class="relative" id="formulario" action="proceso_guardar.php"  method="POST" enctype="multipart/form-data">
      
       <div class="col-md-12">
        <label class="invisibleOp left text-left">Usuario:</label>
        <input class="" type="text" REQUIRED id="usuario" name="usuario" value="<?php echo $_SESSION['u_usuario'] ?>"/><br /><br />
       </div>
       
       <div class="col-sm-6">
        <label class="left text-left">Autor:</label>
        <input type="text" REQUIRED id="autor" name="autor" placeholder="Autor..." value="<?php echo $row['nombre'] ?>"/><br /><br />
       </div>
       
       <div class="col-sm-6">
        <label class="left text-left">Colección:</label>
        <input type="text" REQUIRED id="coleccion" name="coleccion" value="<?php echo $row['coleccion'] ?>"/><br /><br />
       </div>
