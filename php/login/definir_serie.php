...
<head>
  ...
  <title>Publicación de nueva serie| Preservación Digital</title>
  ...
  <script src="see_img.js" type="text/javascript"></script>
    ...
    <div class="row">
     <div class="">
      ...
      <?php
		...
		if($SelectColeccion == $row['usuario']){
      ...
      <form class="relative" id="formulario" action="guardar_serie.php"  method="POST" enctype="multipart/form-data">
      
       <div class="col-md-12">
        <input class="" type="hidden" REQUIRED id="usuario" name="usuario" value="<?php echo $_SESSION['u_usuario'] ?>"/><br /><br />
       </div>
       
       <div class="col-sm-6">
        <label class="left text-left">Autor: <?php echo $row['autor']; ?> </label>
        <input type="hidden" REQUIRED id="autor" name="autor" value="<?php echo $row['autor'] ?>"/><br /><br />
       </div>
       
       <div class="col-sm-6">
        <label class="left text-left">Colección: <?php echo $row['coleccion'] ?> </label>
        <input type="hidden" REQUIRED id="coleccion" name="coleccion" value="<?php echo $row['coleccion'] ?>"/><br /><br />
       </div>
       
       <div class="col-sm-6">
        <label class="left text-left">Nombre de la serie:</label>
        <input type="text" REQUIRED id="serie" name="serie" placeholder="Define el nombre de la serie..." value=""/><br /><br />
       </div>
       ...
       <div class="col-md-12">
        <label class="left text-left">Selecciona una imagen que defina tu serie</label>
