...
<head>
  ...
  <title>Publicación de colección| Preservación Digital</title>
    ...
    <div class="row">
     <div class="col-md-12">
      ...
      <form class="relative" id="formulario" action="proceso_guardar.php"  method="POST" enctype="multipart/form-data">
       ...
       <input type="text" REQUIRED id="autor" name="autor" placeholder="Autor..." value="<?php echo $_SESSION['u_usuario'] ?>"/><br /><br />
       ...
       <label class="left text-left">Fecha de toma: <span><i>(formato dd/mm/aaaa)</i></span></label>
      <input type="text" REQUIRED name="fecha" placeholder="Fecha de la toma..." value=""/><br /><br />
      <label class="left text-left">Lugar de la toma: <span><i>()</i></span></label>
      <input type="text" REQUIRED name="lugar" placeholder="Lugar de la colección..." value=""/><br /><br />
