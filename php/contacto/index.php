...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body data-spy="scroll" data-offset="60" data-target=".navbar-fixed-top" style="font-family: Hind, sans-serif" class="onepage">
  ...
  <div class="main-wrapper oh">
   <section class="hero-wrap text-center" style="background-image:url(../../themes/img/sections/contacto.jpg)">
    <div class="container container-full-height">
     <div class="hero-holder">
      <div class="hero-message text-rotator">
       <h2>Contáctanos</h2>
       <div class="buttons-holder mt-30">
        <a href="mailto:sociedaddeexperimentacion@gmail.com?subject=Feedback" class="btn btn-lg btn-red"><i class="fa fa-google-plus"></i> &nbsp;&nbsp;sociedaddeexperimentacion@gmail.com</a>
        <a href="https://www.facebook.com/sociedaddeexperimentacion/" target="_blank" class="btn btn-lg btn-blue"><i class="fa fa-facebook"></i> &nbsp;&nbsp;Sociedad de experimentación</a>
       </div>
