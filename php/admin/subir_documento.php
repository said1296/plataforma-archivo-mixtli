...
<head>
  ...
  <title>Publicación de documento| Preservación Digital</title>
   ...
   <div class="container">
    <div class="row">
     <div class="col-md-12">
      ...
      <br /><br />
      <form class="relative" id="formulario" action="guardar_documento.php"  method="POST" enctype="multipart/form-data">
       <label class="left text-left">Título del documento:</label>
       <input type="text" REQUIRED name="documento" placeholder="Título del documento" value=""/><br /><br />
       <label class="left text-left">Año</label>
      <input type="text" REQUIRED name="ano" placeholder="Año del documento" value=""/><br /><br />
      <label class="left text-left">Link o URL: <span><i>(https://archive.org/details/AbuelaLunaPDFLOW/page/n21)</i></span></label>
      <input type="text" REQUIRED name="link" placeholder="Link del documento..." value=""/><br /><br />
      <label class="left text-left">Selecciona una imagen</label>
      <input class="button" type="file" REQUIRED id="imgD" name="imgD" /><br />
