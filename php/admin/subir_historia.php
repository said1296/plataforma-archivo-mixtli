...
<head>
  ...
  <title>Publicación de historia| Preservación Digital</title>
   ...
   <div class="container">
    <div class="row">
     <div class="col-md-12">
        ...
        <br /><br />
        <form class="relative" id="formulario" action="guardar_historia.php"  method="POST" enctype="multipart/form-data">
        <label class="left text-left">Autor:</label>
        <input type="text" REQUIRED name="autor" placeholder="Autor de la historia" value=""/><br /><br />
        <label class="left text-left">Título de la historia:</label>
        <input type="text" REQUIRED name="titulo" placeholder="Título de la historia" value=""/><br /><br />
        <label class="left text-left">Fecha</label>
        <input type="text" REQUIRED name="fecha" placeholder="Fecha" value=""/><br /><br />
        <label class="left text-left">Historia</label>
        <textarea REQUIRED name="texto" rows="10"></textarea><br /><br />
