...
<head>
  ...
  <title>Modificar documento | Preservación Digital</title>
  ...
  <script src="view_document.js" type="text/javascript"></script>
 ...
 <div class="container">
  <div class="row">
   <div class="col-md-9">
    ...
    <br /><br />
     <form action="procesando_modificacion_documento.php?id=<?php echo $row['id']; ?>" method="POST" enctype="multipart/form-data">
      <label class="left text-left">Autor:</label>
      <input type="text" REQUIRED name="autor" placeholder="Autor..." value="<?php echo $_SESSION['u_usuario'] ?>"/><br /><br />
      <label class="left text-left">Título del documento:</label>
      <input type="text" REQUIRED name="documento" placeholder="Título del documento..." value="<?php echo $row['documento'];  ?>"/><br /><br />
      <label class="left text-left">Año:</label>
      <input type="text" REQUIRED name="ano" placeholder="Año del documento..." value="<?php echo $row['ano'];  ?>"/><br /><br />
      <label class="left text-left">Link o URL:</label>
      <input type="text" REQUIRED name="link" placeholder="Link del documento..." value="<?php echo $row['link'];  ?>"/><br /><br />
      <img height="120px" src="data:image/jpg;base64,<?php echo base64_encode($row['imgD']);  ?>"/><br /><br />
      <input class="button" type="file" REQUIRED name="imgD" /><br /><br />
