...
<head>
  ...
  <title>Modificar historia | Preservación Digital</title>
  ...
  <div class="row">
   <div class="col-md-9">
    ...
    <br /><br />
      ...
      <form action="procesando_modificacion_historia.php?id=<?php echo $row['id']; ?>" method="POST" enctype="multipart/form-data">
        <label class="left text-left">Autor:</label>
        <input type="text" REQUIRED name="autor" placeholder="Autor de la historia" value="<?php echo $row['autor'] ?>"/><br /><br />
        <label class="left text-left">Título de la historia:</label>
        <input type="text" REQUIRED name="titulo" placeholder="Título de la historia" value="<?php echo $row['titulo'] ?>"/><br /><br />
        <label class="left text-left">Fecha</label>
        <input type="text" REQUIRED name="fecha" placeholder="Fecha" value="<?php echo $row['fecha'] ?>"/><br /><br />
        <label class="left text-left">Historia</label> <br>
        <textarea REQUIRED name="texto" rows="10"><?php echo $row['texto'] ?></textarea><br /><br />
