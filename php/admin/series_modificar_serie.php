    ...
    <div class="container relative clearfix">
      <div class="title-holder">
        <div class="title-text">
          <h1 class="uppercase">Modificar serie</h1>
        </div>
      </div>
    </div>
   </section>
  ...
  <section>
    <div class="container mt-70 mb-50 alimentar-imagen">
      ...
      <div class="">
        ...
        <!-- Forma foto -->
        <form  action="series_procesar.php?tipo=series&pagina=<?php echo $pagina ?>" id="forma_foto" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-md-6 mb-20">
            <img id="vista_previa" src="data:image/jpg;base64,<?php echo base64_encode($row['imgSerie']);  ?>"/> 
          </div>
          <div class="col-md-6">
          ...
          <div class="col-sm-6">
            ...
            <select REQUIRED id="grupo" name="grupo">
                <option value="Las fiestas del pueblo"
                <?php
                ...
                <option value="Paisaje y Arquitectura"
                <?php
