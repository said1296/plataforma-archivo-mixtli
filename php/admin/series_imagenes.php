      ...
      <div class="container">
         <div class="row">
            <div class="col-sm-12">
               <a href="<?php
                  if($_GET['consulta']){
                     echo "series_buscar.php?consulta=".$_GET['consulta']."&pagina=".$_GET['pagina_buscar'];
                  }
                  else{
                     echo "series.php?pagina=".$paginaSeries;
                  }
                  ...
                  <div class="work-container">
                     <div class="work-img">
                        ...
                        <div class="work-overlay">
                           <a style="width:180px;" href="series_eliminar_imagen.php?id=<?php echo $row['id'].'&serie='.$serie; if(isset($_GET['consulta'])){echo "&consulta=".$_GET['consulta']."&pagina_buscar=".$_GET['pagina_buscar'];}else{echo '&pagina_series='.$_GET['pagina_series'];} echo '&pagina='.$pagina ?>" class="btn btn-lg btn-red">Eliminar</a>
                           <a style="width:180px;" href="series_detalles.php?id=<?php echo $row['id'].'&serie='.$serie; if(isset($_GET['consulta'])){echo "&consulta=".$_GET['consulta']."&pagina_buscar=".$_GET['pagina_buscar'];}else{echo '&pagina_series='.$_GET['pagina_series'];} echo '&pagina='.$pagina ?>" class="btn btn-lg btn-black">Detalles</a>
