         ...
         <div class="row">
            ...
            <div class="col-sm-6">
               <div class="about-description">
                  <form class="relative" action="./proceso_guardar.php" method="POST" enctype="multipart/form-data">
                     ...
                     <input type="text" id="usuario" maxlength="20" REQUIRED name="usuario" value="" placeholder="Ingrese su nombre de usuario..." /><br /><br />
                     ...
                     <input type="email" id="email" REQUIRED name="email" value="" placeholder="Ingrese su correo electrónico..." /><br /><br />

                     <label for="input-label" class="text-left">Edad</label>
                     <input type="number" max="120" id="edad" REQUIRED name="edad" value="" placeholder="Ingrese su edad..." /><br /><br />
